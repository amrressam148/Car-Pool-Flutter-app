...
class AddFacultyTripScreen extends StatefulWidget {
  @override
  _AddFacultyTripScreenState createState() => _AddFacultyTripScreenState();
}

class _AddFacultyTripScreenState extends State<AddFacultyTripScreen> {
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        onChanged: (String? newValue) {
                          setState(() {
                            _destinationController.text = newValue ?? '';
                          });
                        },
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          if (pickedDate != null && pickedDate != _pickUpTime) {
                            final TimeOfDay pickedTime = TimeOfDay(hour: 7, minute: 30); // Set to 7:30 AM
  ...
  Future<void> _saveTripToFirebase() async {
    ...
    if (user != null) {
      ...
      if (carDetailsMap != null && driverMap != null) {
        ...
        final newTripRef = databaseReference.child('Go Faculty Trips/$userId').push();
